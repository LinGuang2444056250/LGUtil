...
//  MicroCityProgram
//
//  Created by huadong on 15/3/2.
//  Copyright (c) 2015年 slideview. All rights reserved.
//

#import <UIKit/UIKit.h>

@interface LGBadgeView : UIView
{
	NSUInteger _value;
}
...
@property (assign,nonatomic) UIEdgeInsets badgeOffset;
...
+ (void)showInView:(UIView *)superView badgeValue:(NSInteger)value;

+ (void)showInView:(UIView *)superView badgeValue:(NSInteger)value badgeViewOffset:(UIEdgeInsets)badgeViewOffset;

+ (void)removeBadgeViewAtView:(UIView *)superView;

@end

@interface LGBadgeSpotView : UIView

// the badge spot dia
@property (assign,nonatomic) CGFloat dia;

// view offset
@property (assign,nonatomic) UIEdgeInsets offSet;
...
+ (void)showInView:(UIView *)superView badgeSpotOffset:(UIEdgeInsets)badgeSpotOffset;

+ (void)removeBadgeSpotAtView:(UIView *)superView;
